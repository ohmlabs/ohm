(function() {
  ...
  function Ohm(config) {
    var ParseDashboard, ParseServer, SessionDataStore, io, ohmSessionDataStore, ensureAuthenticatedSocket, ohmCookieParser, S3Adapter, session, server, helmet, bodyParser, cookieParser, errorHandler, express, http, logger, methodOverride, parentApp, path;
