(function() {
  ...
  function Ohm(config) {
    ...
    parentApp.use(config.GHOST_PATH, ghost({
      config: path.join(process.cwd(), config.GHOST_CONFIG)
    }));
    ///////////////////////////////////
    //   Start Server               //
    /////////////////////////////////
    require(path.join(process.cwd(), config.SOCKETS))(io, parentApp);
    require(path.join(process.cwd(), config.ROUTES))(parentApp);
    // Listen
