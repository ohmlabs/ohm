(function() {
  ...
  const GoogleMapper = React.createClass({
    ...
    tooltip: function(loc = {}) {
      const address   = loc.google ? loc.google.formatted_address : loc.address;
      const rating    = loc.google ? loc.google.rating : null;
      const phone     = loc.google ? loc.google.formatted_phone_number : loc.phone;
      const website   = loc.google ? loc.google.website.replace(/.*?:\/\//g, "") : loc.url;
      ...
      const tooltip   = (
        <div className={classes}>
          <a href={website} target="_blank"><p className="name">{loc.name}</p></a>
